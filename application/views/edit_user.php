                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5 text-center">
                            ...
                            <form method="post" action="<?php echo base_url('auth/update') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" value="<?php echo $this->session->userdata('username') ?>" class="form-control form-control-user" placeholder="Username Anda" name="username">
                                ...
                                <button type="submit" class="btn btn-user btn-block btn-primary">Simpan </button>
